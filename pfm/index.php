...
<style>
body {background-image:url('cover.jpg');background-repeat:no-repeat;background-attachment:fixed;background-size:700px 700px;background-position:center center}
</style>
<body>
<?php

//Scans directory for filenames
$dir    = '/home5/jeehtove/public_html/jtunes/pfm';
$files1 = scandir($dir);
$count = 1;
...
//Display Album Title
echo "<p align='center'><font face='verdana' size='6'>" . substr(strrchr($dir,"/"),1) . "</font></p><br><br>";
...
//The real album count. The folder contains the cover.jpg, index.php file, download.gif, and the "." and ".." navigation nodes, so 3 is subtracted from the total count
$real_count = count($files1) - 6;

//Generate random number for the audio player to play random tracks from album
$rand_num = rand(1,$real_count);

//Download Album Link
echo "<br><br><center><font face='verdana'><a href='" . substr(strrchr($dir,"/"),1) . ".zip'><img src='download.gif' alt='Download Now!' length='100' width='100'></a></font></center><br><br>";

//Album information
echo "<center><font face='verdana'>There are " . $real_count . " tracks in this album.</font></center><br>";
echo "<center><font face='verdana'>Now Playing: <b><i>" . $files1[$rand_num] . "</b></i></font></center><br>";
